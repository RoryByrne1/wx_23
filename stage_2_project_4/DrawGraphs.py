...
class DrawGraph:
    ...
    def draw(self, canvas, x_data, y_data, bars, peaks_finder):
        ...
        if peaks_finder:
            ...
            peaks_x, peaks_y = peak_finder.get_peaks_x_y(y_data, 4, 30, 1) #data, maxNumberOfPeaks, (relative)minPeakSize, filterLevel
            self._plot_ref_peak = canvas.axes.scatter(peaks_x * (11/2200) - 0.5, peaks_y + 0.02, s=40, marker='v', color="red", alpha=0.7)
